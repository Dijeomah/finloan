...
@section('view')
        <div class="page-body">
            ...
            <div class="container-fluid dashboard-default">
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex d-block justify-content-between">
                                    <div class="flex-grow-1">
                                        <div class="weather d-flex">
                                            ...
                                            <div class="span sun-bg"><i class="icofont icofont-sun font-primary"></i>
                                            </div>
                                        </div>
                                        <span class="font-primary f-w-700">Sunny Day</span>
                                ...
                                <div class="greeting-user">
                                    <div class="profile-vector">
                                        ...
                                        <img class="img-fluid"
                                             src="{{asset('admin_assets/images/dashboard/default/profile.png')}}"
                                             alt="">
                                        <ul class="vector-image">
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon1.png')}}"
                                                    alt=""></li>
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon3.png')}}"
                                                    alt=""></li>
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon4.png')}}"
                                                    alt=""></li>
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon5.png')}}"
                                                    alt=""></li>
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon6.png')}}"
                                                    alt=""></li>
                                            <li><img
                                                    src="{{asset('admin_assets/images/dashboard/default/ribbon7.png')}}"
                                                    alt=""></li>
                                        </ul>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 box-col-30">
                        <div class="card total-revenue overflow-hidden">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1">
                                        <p class="square-after f-w-600 header-text-primary">Our Total Revenue<i
  ...
  &lt;div class="card-header"&gt;
    &lt;div class="d-flex justify-content-between"&gt;
      &lt;div class="flex-grow-1"&gt;
        &lt;p class="square-after f-w-600 header-text-primary"&gt; Our Total Revenue
                            ...
                            <div class="card-body">
                                ...
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard"
                                            data-clipboard-target="#investment"><i class="icofont icofont-copy-alt"></i>
                                    </button>
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-md-6 dash-30 box-col-30">
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="col-xl-4 col-md-6 box-col-40">
                        <div class="card appointment-detail">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid align-top circle"
                                                                         src="{{asset('admin_assets/images/dashboard/default/01.png')}}"
                                                                         alt="">
                                            ...
                                            <td class="text-end">
                                                <button class="btn btn-primary" type="button"
                                                        onclick="document.location='user-cards.html'">Pending
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid align-top circle"
                                                                         src="{{asset('admin_assets/images/dashboard/default/02.png')}}"
                                                                         alt="">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid align-top circle"
                                                                         src="{{asset('admin_assets/images/dashboard/default/03.png')}}"
                                                                         alt="">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid align-top circle"
                                                                         src="{{asset('admin_assets/images/dashboard/default/04.png')}}"
                                                                         alt="">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex"><img class="img-fluid align-top circle"
                                                                         src="{{asset('admin_assets/images/dashboard/default/05.png')}}"
                                                                         alt="">
                                ...
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard"
                                            data-clipboard-target="#appoinment"><i class="icofont icofont-copy-alt"></i>
                                    </button>
      ...
      &lt;table class="table"&gt;
        &lt;tbody&gt;
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('admin_assets/images/dashboard/default/01.png')}}" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('admin_assets/images/dashboard/default/02.png')}}" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('admin_assets/images/dashboard/default/03.png')}}" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('admin_assets/images/dashboard/default/04.png')}}" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('admin_assets/images/dashboard/default/05.png')}}" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="col-xl-4 col-md-6 box-col-30">
                                ...
                                <div class="activity-timeline">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1"><span class="f-w-600 d-block">Updated Product</span>
                                            <p class="mb-0">I like to be real. I don't like things to be staged or
                                                fussy.</p>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1"><span
                                                class="f-w-600 d-block">You liked James products</span>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <i class="fa fa-circle circle-dot-primary"></i>
                                    </div>
                                    <div class="d-flex">
                                        <div class="activity-dot-primary"></div>
                                    ...
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1"><span class="f-w-600 d-block">Jihan Doe just like your product</span>
                                            <p class="mb-0">Design and style should work toward making you look good and
                                                feel good without lot of effort.</p>
                                        </div>
                                        <i class="fa fa-circle circle-dot-secondary"></i>
                                    </div>
                                </div>
                                <div class="code-box-copy">
                                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#activity">
...
&lt;/div&gt; </code></pre>
                    ...
                    <div class="col-xl-4 proorder box-col-4">
                            ...
                            <div class="card-body">
                                <div class="activity-timeline todo-timeline">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex mt-0"><img class="img-fluid img-30"
                                                                          src="{{asset('admin_assets/images/dashboard/default/todo.png')}}"
                                                                          alt="">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mt-0 todo-font"><span class="font-primary">20-04-2022 </span>Today<span
                                                ...
                                                class="f-w-600">James just like your product<i
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <p class="mt-0 todo-font"><span class="font-primary">20-04-2022 </span>Today
                                            </p><span class="f-w-600">Jihan Doe just like your product</span>
                                            <p class="mb-0">Design and style should work making you look good and feel
                                                good without lot of effort.</p>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                                        <div class="activity-dot-primary"></div>
                                        <div class="flex-grow-1">
                                            <p class="mt-0 todo-font"><span class="font-primary">20-04-2022 </span>Today
                                            </p><span class="f-w-600">Take Our Client Metting<i
                                                    class="fa fa-circle circle-dot-primary pull-right"></i></span>
      ...
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          ...
          &lt;div class="d-flex mt-0"&gt;
            &lt;img class="img-fluid img-30" src="{{asset('admin_assets/images/dashboard/default/todo.png')}}" alt=""/&gt;
            &lt;div class="flex-grow-1"&gt;
